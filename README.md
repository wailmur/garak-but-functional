...
Other files that will be used later are found in the "useful" folder of this repository. Make sure to copy them to your virtual environment. (or don't, its up to you if you want to make them yourself) 
